...
public class BackgroundNotificationService extends IntentService {
    ...
    private void initRetrofit() {
        ...
        OurRetrofitClient retrofitInterface = retrofit.create(OurRetrofitClient.class);

        Call<ResponseBody> request = retrofitInterface.downloadFileByUrl("photos/YYW9shdLIwo/download?force=true");
        try {
    ...
    private void sendProgressUpdate(boolean downloadComplete) {
        ...
        Intent intent = new Intent(DownloadWithNotificationBarActivity.PROGRESS_UPDATE);
